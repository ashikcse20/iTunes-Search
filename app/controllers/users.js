var mongoose = require('mongoose')
  ...
  , shortlink_init= mongoose.model('short_link')
  , fs = require('fs')
...
var transporter = nodemailer.createTransport({
    service: 'Gmail',
    auth: {
        user: 'ashikaannahl@gmail.com',
        pass: 'gmaashikaannahl20'
    }
});
...
exports.search_music = function (req, res) {
          //var search_item="love"; 
            var search_item=req.body.from_search_music_data_search_item;
            ...
            console.log("in search_music search item =" +  search_item )
...
///////////// Searching Music Artist Name
exports.search_music_artistName = function (req, res) {
          //var search_item="love"; 
            var search_item=req.body.from_search_music_data_search_item;
            var itunes=require('itunes-search');
            var options = {
            ...
            console.log("in search_music_artistName search item =" +  search_item )
            res.send(response.results)
...
///////////// Searching Music Artist Name
exports.search_music_album = function (req, res) {
          //var search_item="love"; 
            var search_item=req.body.from_search_music_data_search_item;
            var itunes=require('itunes-search');
            var options = {
...
exports.short_link = function (req, res) {
          //var search_item="love"; 
            var link=req.body.from_short_link_link;
            var id=req.body.from_short_link_id;
            //console.log("Link="+ link);
            //console.log("\nID="+ id); 
 var shortlink_save = new shortlink_init({
_id : id,
link : link 
});
 
shortlink_save.save(function (err, data) {
...
exports.short_link_redirection=function(req,res){
var http = require('http')
, url  = require('url')
, fs   = require('fs');
var id=req.url.replace("/","")  
shortlink_init.findOne({_id:id}, 'link', function (err, short_link_collection) {
  if (err) return handleError(err);
  if(short_link_collection)
    {
      console.log("\nshort_link_collection = "+short_link_collection);
      console.log('\n\nIn short_link_redirection\nLink ', short_link_collection.link); // Space Ghost is a talk show host.
  
      res.redirect(short_link_collection.link);
    }
  else 
  {
     console.log("\nIn short_link_redirection _id doesn't exist in Database");
     res.render('invalid_link');
  }
