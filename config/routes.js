...
module.exports = function (app,passport,auth,io) {
  ...
  app.post('/search_artistname', users.search_music_artistName);
  app.post('/search_album', users.search_music_album);
  app.post('/short_link', users.short_link);
...
////////////For Short Link Redirection
app.get('*', users.short_link_redirection);
